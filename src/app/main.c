...
uint8_t longitudedtbuf[30];
uint8_t latitudedtbuf[30];
uint8_t dtbuf[50]; 
...
uint8_t lock_open_success_flag = 0;
...
////////////////////////////////////
 ...
 uint8_t LOCK_ON_flag=1;
 uint8_t LOCK_OFF_flag=1;
...
extern uint8_t PARK_LOCK_Buffer[17];
...
//		//接收锁数据
		...
		p2 = strstr((uint8_t *)p1,(uint8_t *)PARK_LOCK_Buffer);
