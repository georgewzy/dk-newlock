...
#define EEPROM_LOCK_ID_OFFSET		0	
#define EEPROM_LOCK_ID_ADDR			EEPROM_BASE_ADDR + EEPROM_LOCK_ID_OFFSET
...
#define EEPROM_OPEN_LOCK_ACK_OFFSET		EEPROM_PORT_OFFSET + EEPROM_PORT_SIZE
#define EEPROM_OPEN_LOCK_ACK_ADDR		EEPROM_BASE_ADDR + EEPROM_OPEN_LOCK_ACK_OFFSET
#define EEPROM_OPEN_LOCK_ACK_SZIE		1


#define EEPROM_CLOSE_LOCK_ACK_OFFSET	EEPROM_OPEN_LOCK_ACK_OFFSET + EEPROM_OPEN_LOCK_ACK_SZIE
#define EEPROM_CLOSE_LOCK_ACK_ADDR		EEPROM_BASE_ADDR + EEPROM_OPEN_LOCK_ACK_OFFSET
#define EEPROM_CLOSE_LOCK_ACK_SZIE		1
